...
#define UE_PROJECT_NAME BricksBreakerJC
#define UE_TARGET_NAME BricksBreakerJCEditor
#define UE_MODULE_NAME "BricksBreakerJC"
...
#define BRICKSBREAKERJC_API DLLEXPORT
